...
#You have graduated from MIT and now have a great job! You move to the San Francisco Bay 
#Area and decide that you want to start saving to buy a house. As housing prices are very 
#high in the Bay Area, you realize you are going to have to save for several years before 
#you can afford to make the down payment on a house. In Part A, we are going to determine 
#how long it will take you to save enough money to make the down payment given the following 
#assumptions:
...
#at the end of each month, you receive an additional ​current_savings*r/12​ funds to put into your savings – 
...
#7. At the end of each month, your savings will be increased by the return on your investment, plus a 
...
#Try different inputs and see how long it takes to save for a down payment. program print results in the format shown in the test cases below.
#Test Case 1
#>>>
#Enter your annual salary:​ 120000
#Enter the percent of your salary to save, as a decimal:​ .10 Enter the cost of your dream home:​ 1000000
