...
//
// What to do:
// 1. Compile the following code and run it on an input "40" to check that it
// is slow.
//    You may also want to submit it to the grader to ensure that it gets the
//    "time limit exceeded" message.
// 2. Implement the fibonacci_fast procedure.
// 3. Remove the line that prints the result of the naive algorithm, comment
// the lines reading the input,
//    uncomment the line with a call to test_solution, compile the program, and
//    run it. This will ensure that your efficient algorithm returns the same
//    as the naive one for small values of n.
// 4. If test_solution() reveals a bug in your implementation, debug it, fix
