...
int get_change(int m) {
	...
	//			possible change smaller than m for the biggest denomination,
	//			continue the process with the remainder until the last possible denom.
	//			Since the smallest denomination is '1' and m is an int, there will 
	//			always be combination of denominations that would equal m.
	int tens = m / 10;
