...
#         Add --max or --stress to pass the respective flag to test_maker.sh.
#==============================================================================#
...
# Process additional optional arguments (-v, --tests, --max, --stress)
for arg in "$@"; do
    if [ "$arg" = "-v" ]; then
        verbose=true
    elif [ "$arg" = "--tests" ]; then
...
# Step 7: Calculate and print average time for both programs
