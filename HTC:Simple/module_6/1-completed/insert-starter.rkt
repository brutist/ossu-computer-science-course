...
(define BST4 (make-node 4 "dcj" false false))
(define BST3 (make-node 3 "ilk" BST1 BST4))
(define BST42 
  (make-node 42 "ily"
             (make-node 27 "wit" false false)
             false))
...
;; insert the given key<int> and value<string> in the proper place of the tree
;;     - assumes the given integer is not a key in the tree
;; examples/test
